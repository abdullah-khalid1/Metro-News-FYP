...
class AllAuthorsPostListAdapter(
    private val context: Context,
    private val list: ArrayList<Post>,
    private val dbrefernce: DatabaseReference,
    private val activity: Activity
) : RecyclerView.Adapter<AllAuthorsPostListAdapter.MyHolder>() {
        ...
        val alertDialog =
            AlertDialog.Builder(context).setTitle("Action Needed")
                ...
                .setNegativeButton("Delete") { dialog, which ->
                    ...
                    if (CheckInternet((context)).isNetworkOnline1()) {

                        dbrefernce.child(id).removeValue().addOnFailureListener {
